...
static MethodProto xlibMethods[] = {
	...
	{ "setColor",			BackdropXObj::m_setColor,		1, 3,	400 },
	{ "setBgColor",			BackdropXObj::m_setBgColor,		1, 3,	400 },
	...
	{ "register",			BackdropXObj::m_register,		2, 2,	400 },
	{ nullptr, nullptr, 0, 0, 0 }
};

BackdropXObject::BackdropXObject(ObjectType ObjectType) :Object<BackdropXObject>("BackdropXObj") {
	_objType = ObjectType;
}

void BackdropXObj::open(int type) {
	if (type == kXObj) {
		BackdropXObject::initMethods(xlibMethods);
		BackdropXObject *xobj = new BackdropXObject(kXObj);
...
void BackdropXObj::close(int type) {
	if (type == kXObj) {
...
XOBJSTUB(BackdropXObj::m_register, 0)
